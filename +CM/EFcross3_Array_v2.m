%% YT 10/19
    % Simplified versions of  efcross3Array.m
    
classdef EFcross3_Array_v2 < handle
    ...
    methods (Access = public)
        function obj = EFcross3_Array_v2(x, seshDate)
            %
            ...
            obj.trialResponse = x.saved.efcross3obj_response_history; % done trials
